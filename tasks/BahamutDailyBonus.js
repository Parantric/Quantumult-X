...
async function BahamutLogin(retry = 3, interval = 1000) { //登录函数，拿到Set-Cookie
	...
	//账号错误: {"code":0,"message":"查无此人：SDFOUGB"}
	//密码错误: {"code":0,"message":"帐号、密码或验证码错误！"}
	//验证码错误: {"code":0,"message":"验证码错误"}
...
function StartSignBahamut(token) { //巴哈姆特签到
	...
	//已签过: {"error":{"code":0,"message":"今天您已经签到过了喔","status":"","details":[]}}
	//未登录: {"error":{"code":401,"message":"尚未登入","status":"NO_LOGIN","details":[]}}
	//令牌过期: {"error":{"code":403,"message":"网页已过期","status":"CSRF_TOKEN_ERROR","details":[]}}
...
function StartSignGuild(v) { //巴哈姆特公会签到
	...
	//签到成功: {"ok":1,"msg":"本日签到成功！获得5贡献度"}
	//已签过: {"error":1,"msg":"您今天已经签到过了！"}
	//公会ID错误: {"error":1,"msg":"此公会社团不存在。"}
	//未加入公会: {"error":1,"msg":"你还不是成员，欢迎加入！"}
	//未登录: {"error":1,"msg":"请先登入"}
...
function BahamutAnswer() { //动画疯答题
	...
	//未答题: {"game":"灌篮高手","question":"流川枫的号码是下列何者？","a1":"7","a2":"11","a3":"23","a4":"59","userid":"GN32964174","token":"01092fe463ab36ab47cb298e229c4f8fb298e229cc260fa7baf"}
	//已答题: {"error":1,"msg":"今日已经答过题目了，一天仅限一次机会"}
	//未登录: {"error":1,"nologin":1,"msg":"请先登入"}
...
function StartBahamutAnswer(answer, token) { //动画疯答题
	...
	//答题正确: {"ok":1,"gift":"恭喜您得到：300 巴币"}
	//答题错误: {"error":1,"msg":"答题错误"}
	//令牌过期: {"error":1,"msg":"很抱歉！本题目已超过时效！"}
	//已答题: {"error":1,"msg":"今日已经答过题目了，一天仅限一次机会"}
	//未登录: {"error":1,"nologin":1,"msg":"请先登入"}
